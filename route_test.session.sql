...
-- @block   
SELECT *
FROM expense_rate -- @block   
delete from expense_rate -- @block
  DROP TABLE expense_rate -- @block
  CREATE TABLE taxes(
...
SELECT *
FROM taxes -- @block   
delete from taxes -- @block
  DROP TABLE taxes -- @block
  CREATE TABLE tips (
...
SELECT *
FROM tips -- @block   
delete from tips -- @block
  DROP TABLE tips -- @block
  CREATE TABLE items (
