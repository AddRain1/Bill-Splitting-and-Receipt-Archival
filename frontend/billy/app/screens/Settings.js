...
import { Alert, SafeAreaView, Text, TouchableOpacity, Switch, View, ScrollView } from 'react-native';
...
function Settings(props) {
    ...
    const toggleBillSwitch = () => setIsBillEnabled(previousState => !previousState);
    const toggleUnpaidSwitch = () => setIsUnpaidEnabled(previousState => !previousState);
    const toggleSummarySwitch = () => setIsSummaryEnabled(previousState => !previousState);
    ...
    return (
        <SafeAreaView style = {styles.container}>
            ...
            <SafeAreaView style={[styles.input, {flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', margin:8,}]} >
                <Text style = {styles.body1}> New bill notification </Text>
                <View style={{marginRight:8, transform: [{ scale: .8 }] }}>
                    <Switch
            ...
            <TouchableOpacity style={[styles.submitButton, {marginTop: 15}]} onPress={handleUpdate}>
                <Text style = {styles.submitText}> Update </Text>
            </TouchableOpacity> 

            <TouchableOpacity style={[styles.input, {marginTop: 25}]} onPress={handleConfirmation}>
