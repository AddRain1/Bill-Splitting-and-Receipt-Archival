	...
	return (
		<SafeAreaView>
			<Text
				style={[
					styles.heading1,
					{ position: "absolute", width: 275, height: 56, top: 300, left: 50 },
				]}
			>
				Forgot Password
			</Text>
			<TouchableOpacity
				style={[
					styles.backButton,
					{ position: "absolute", width: 154, height: 25, top: 355, left: 55 },
				]}
